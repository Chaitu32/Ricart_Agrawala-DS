...
def home():
    ...
    if request.method == 'POST':
        ...
        if node in nodes:
            return render_template('index.html', nodes=nodes, critical_nodes=critical_nodes, num_count=num_count, critNode=critNode,
...
def add_critical():
    ...
    num_nodes = int(request.form['num_count'])
    array = [ request.form[f'node_{i}'] for i in range(num_nodes)]
    print(array)
